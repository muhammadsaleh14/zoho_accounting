// File: apps/web-plugin/src/pages/SettingsPage.tsx
import {
  User,
  Shield,
  Bell,
  ...
  const sections = [
    {
      ...
      desc: "Manage your personal information, contact details, and official trade license documents.",
      status: "Complete",
    },
    {
      icon: Shield,
      label: "Security & Password",
      desc: "Secure your account with 2FA, change your password, and manage active sessions.",
      status: "High",
    },
    {
      icon: Bell,
      label: "Notification Preferences",
      desc: "Configure how and when you receive compliance alerts and report generation emails.",
      status: "Flexible",
    },
    {
      icon: Smartphone,
      label: "Connected Devices",
      desc: "Manage mobile devices and tablets with access to your Zoho Vault.",
      status: "3 Active",
    },
    {
      icon: Globe,
      label: "Language & Region",
      desc: "Set your preferred language, time zone, and fiscal year settings.",
      status: "English (UK)",
    },
    {
      icon: CreditCard,
      label: "Subscription & Billing",
      desc: "Manage your premium plan, view billing history, and update payment methods.",
      status: "Premium",
    },
  ];
    ...
    <div className="max-w-4xl mx-auto py-4">
      <div className="mb-8 lg:mb-10">
        ...
        <p className="text-slate-500 mt-2 font-medium">
          Fine-tune your platform experience and account security.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6">
        {sections.map((section, i) => (
          <div
            key={i}
            className="glass-card p-5 lg:p-6 flex gap-5 hover:scale-[1.02] transition-all cursor-pointer group relative overflow-hidden"
          >
            ...
            <div className="flex-1">
              ...
              <p className="text-xs lg:text-sm text-slate-500 font-medium leading-relaxed mb-3 pr-4">
                {section.desc}
              </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 text-center sm:text-left">
          <div>
            ...
            <p className="text-sm text-rose-600 font-medium">
              Once archived, your data will be stored for 7 years as per UAE
              law.
            </p>
          </div>
