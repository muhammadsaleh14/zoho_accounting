        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="glass-card p-6 flex flex-col justify-between overflow-hidden relative group">
                ...
                <div>
                    ...
                    <h3 className="text-2xl font-black text-slate-900 tracking-tight">AED 124,550.00</h3>
                    <p className="text-[10px] text-slate-400 font-medium mt-1">Updated 2 mins ago</p>
                </div>
            </div>
            ...
            <div className="glass-card p-6 flex flex-col justify-between overflow-hidden relative group">
                ...
                <div>
                    ...
                    <h3 className="text-2xl font-black text-slate-900 tracking-tight">AED 42,300.25</h3>
                    <p className="text-[10px] text-slate-400 font-medium mt-1">Pending approval: 8 docs</p>
                </div>
            </div>
            ...
            <div className="glass-card p-6 flex flex-col justify-between overflow-hidden relative group">
                ...
                <div>
                    ...
                    <h3 className="text-2xl font-black text-slate-900 tracking-tight">94%</h3>
                    <div className="w-full bg-slate-100 h-1.5 rounded-full mt-3 overflow-hidden">
                        <div className="bg-emerald-500 h-full rounded-full transition-all duration-1000" style={{ width: '94%' }}></div>
                    </div>
                </div>
            </div>
        </div>
